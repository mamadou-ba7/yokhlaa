...
export default function ProfileScreen({ navigation }) {
  ...
  const menuItems = [
    ...
    ...(isDriver ? [
      { icon: 'document-text-outline', label: 'Mes documents', screen: 'DriverDocuments' },
      { icon: 'card-outline', label: 'Abonnement', screen: 'Subscription' },
    ] : []),
    { icon: 'help-circle-outline', label: 'Aide', screen: 'Help' },
    { icon: 'shield-checkmark-outline', label: 'Conditions d\'utilisation', screen: 'Terms' },
    { icon: 'lock-closed-outline', label: 'Politique de confidentialite', screen: 'Privacy' },
